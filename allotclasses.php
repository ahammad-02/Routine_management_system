...
<div align="center">
    ...
    <table id=allotedclassroomstable>
        ...
        $q = mysqli_query(mysqli_connect("localhost", "root", "", "ttms"),
            "SELECT * FROM classrooms ");
        $courses = array('B.Sc ( Semester I )', 'B.Sc ( Semester II )', 'B.Sc ( Semester III )', 'B.Sc ( Semester IV )', 'B.Sc ( Semester V )', 'B.Sc ( Semester VI )', 'B.Sc ( Semester VII )', 'B.Sc ( Semester VIII )');
        while ($row = mysqli_fetch_assoc($q)) {
            if ($row['status'] == 0)
                continue;
