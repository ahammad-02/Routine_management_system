...
if (isset($_POST['select_semester'])) {
    $selected_semester = $_POST['select_semester'];
    $table = " semester" . $selected_semester . " ";
}
            ...
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">ALLOTMENT
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href=allotpracticals.php>SESSIONAL COURSES</a>
                        </li>
                        <li>
                ...
                <li><a href="generatetimetable.php">GENERATE ROUTINE</a></li>
...
<form action="generatetimetable.php" method="post">
    <div align="center" style="margin-top: 20px">
        ...
        <button type="submit" id="viewsemester" class="btn btn-success btn-lg" style="margin-top: 5px">VIEW ROUTINE</button>
    </div>
</form>
...
if (isset($_POST['select_semester'])) {
    ...
    $id = isset($_POST['select_teacher']) ? $_POST['select_teacher'] : $_GET['display'];
    $connection = mysqli_connect("localhost", "root", "", "ttms");
    if (!$connection) {
        die("Connection failed: " . mysqli_connect_error());
    }
...
<script type="text/javascript">
    function gendf() {
        ...
        if (typeof select_semester !== 'undefined') {
            filename = 'ttms semester ' + select_semester;
        } else if (typeof select_teacher !== 'undefined') {
            filename = 'ttms ' + select_teacher;
        } else if (typeof loggedin_id !== 'undefined') {
            filename = 'ttms ' + loggedin_id;
        }
